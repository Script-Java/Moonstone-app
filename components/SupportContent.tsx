...
export function HelpFAQContent() {
    return (
        <View>
            <Text className="text-white text-2xl font-extrabold mb-6">Frequently Asked Questions</Text>

            <View className="mb-6">
                <Text className="text-primary font-extrabold text-base mb-3">How do I create a story?</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
            ...
            <View className="mb-6">
                <Text className="text-primary font-extrabold text-base mb-3">How do credits work?</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
            ...
            <View className="mb-6">
                <Text className="text-primary font-extrabold text-base mb-3">Can I download my stories?</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
            ...
            <View className="mb-6">
                <Text className="text-primary font-extrabold text-base mb-3">How do I change the narrator voice?</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
            ...
            <View className="mb-6">
                <Text className="text-primary font-extrabold text-base mb-3">What is the sleep timer?</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
            ...
            <View className="mb-4">
                <Text className="text-primary font-extrabold text-base mb-3">Need more help?</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
...
export function PrivacyPolicyContent() {
    return (
        <View>
            ...
            <Text className="text-white/40 font-semibold text-sm mb-8">Last updated: January 9, 2026</Text>

            <Text className="text-white/70 font-medium text-base leading-7 mb-6">
            ...
            <View className="mb-6">
                <Text className="text-primary font-extrabold text-base mb-3">Information We Collect</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
            ...
            <View className="mb-6">
                <Text className="text-primary font-extrabold text-base mb-3">How We Use Your Data</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
            ...
            <View className="mb-6">
                <Text className="text-primary font-extrabold text-base mb-3">Data Security</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
            ...
            <View className="mb-6">
                <Text className="text-primary font-extrabold text-base mb-3">Your Rights</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
            ...
            <View className="mt-4 p-4 bg-white/5 rounded-2xl border border-white/10">
                <Text className="text-white/60 font-medium text-sm leading-6 text-center">
                    For the complete privacy policy, please visit{"\n"}
                    <Text className="text-primary font-bold">moonstone.app/privacy</Text>
                </Text>
            </View>
        </View>
    );
...
export function TermsOfServiceContent() {
    return (
        <View>
            ...
            <View className="mb-6">
                <Text className="text-primary font-extrabold text-base mb-3">Acceptance of Terms</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
            ...
            <View className="mb-6">
                <Text className="text-primary font-extrabold text-base mb-3">Service Description</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
            ...
            <View className="mb-6">
                <Text className="text-primary font-extrabold text-base mb-3">Credits & Payments</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
            ...
            <View className="mb-6">
                <Text className="text-primary font-extrabold text-base mb-3">Content Ownership</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
            ...
            <View className="mb-6">
                <Text className="text-primary font-extrabold text-base mb-3">Prohibited Use</Text>
                <Text className="text-white/70 font-medium text-base leading-7">
            ...
            <View className="mt-4 p-4 bg-white/5 rounded-2xl border border-white/10">
                <Text className="text-white/60 font-medium text-sm leading-6 text-center">
                    ...
                    <Text className="text-primary font-bold">moonstone.app/terms</Text>
                </Text>
            </View>
        </View>
    );
